...
Usage:
    python experiments/drop_coin.py                # CPU, batch mode
    python experiments/drop_coin.py --gpu          # GPU (CUDA)
    python experiments/drop_coin.py --live         # live 3-panel dashboard
    python experiments/drop_coin.py --live --gpu   # live + GPU sweep
