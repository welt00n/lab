...
Usage:
    python experiments/drop_cube.py                # CPU, batch mode
    python experiments/drop_cube.py --gpu          # GPU (CUDA)
    python experiments/drop_cube.py --live         # live 3-panel dashboard
    python experiments/drop_cube.py --live --gpu   # live + GPU sweep
"""
